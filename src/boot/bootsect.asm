...
; includes
%include "boot/pre32_functions/print_char.asm"
%include "boot/pre32_functions/print_cstring.asm"
%include "boot/pre32_functions/clear_screen.asm"
%include "boot/pre32_functions/load_sectors.asm"
%include "boot/pre32_functions/pm_switch.asm"
%include "boot/pre32_functions/load_kernel.asm"
%include "boot/gdt/gdt.asm"
%include "boot/32pm_functions/print_string_pm.asm"
